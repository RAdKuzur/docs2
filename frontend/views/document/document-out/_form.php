...
<div class="document-in-form">
    ...
    <?= $form->field($model, 'document_number')->textInput()->label('Регистрационный номер исходящего документа') ?>
    <?= $form->field($model, 'document_name')->textInput()->label('Название исходящего документа') ?>
